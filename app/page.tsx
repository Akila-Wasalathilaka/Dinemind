...
export default function HomePage() {
  ...
  return (
    <main className="md:ml-[200px]"> {/* Add left margin for sidebar on desktop */}
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-12 md:px-24">
          ...
          >
            ...
            <p className="text-xl text-gray-100 mb-8">
              Personalized recommendations that understand your unique taste profile, dietary preferences, and flavor adventures you$apos;ve yet to explore.
            </p>
      ...
      <section className="py-20 px-12 md:px-24 bg-white">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Our AI adapts and evolves with every interaction, continuously improving your food recommendations
          </p>
        </div>
            ...
            {['trending', 'new', 'recommended'].map((tab) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg capitalize ${
                  activeTab === tab ? 'bg-white shadow-sm font-medium' : 'text-gray-500 hover:text-gray-800'
                }`}
              >
                {tab}
              </button>
      ...
      <section className="py-20 px-12 md:px-24 bg-gradient-to-br from-red-600 to-red-800 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <div className="font-medium">— Sarah Johnson, Food Enthusiast</div>
          </motion.div>
        </div>
      </section>
